...
export default class FuncCell extends Component {
  ...
  render () {
    ...
    return (
      <button className={`func-cell func-cell-${this.props.columns}`}
        onClick={this.props.onClick && this.props.onClick.bind(this)}
        style={{width: this.state.funcCellWidth, height: this.state.funcCellWidth}}>
        {this.props.badge ?
          <Badge className='home-badge'>{this.props.badge > 99 ? '99+' : this.props.badge}</Badge> : null}
