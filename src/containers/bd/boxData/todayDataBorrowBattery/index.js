        ...
        {this.props.summaryData && !this.props.error
          ? <div className='total'>
            ...
            <ul className='clearfix'>
              ...
              <li>借出充电宝数：{this.props.summaryData.todayLoadDeviceNum || 0}</li>
              <li>归还数：{this.props.summaryData.todayReturnDeviceNum || 0}</li>
              {/* <li>设备日均借出数：{this.props.summaryData.boxRefundOrdersNum || 0}</li> */}
            </ul>
          </div> : null}
        {/* 表格标题 */}
        <ScrollOnTop className="scroll-on-top-wap">
          <div className='table-head'>
            ...
            <span className='th wid03'>
              <em className='txt'>借出<br />次数</em>
              <button className='btn-up' onClick={() => this._choseSortType(3, 'TODAY_LOAD_DEVICE_NUM', 'ASC')} />
              <button className='btn-down' onClick={() => this._choseSortType(4, 'TODAY_LOAD_DEVICE_NUM', 'DESC')} />
            ...
            <span className='th wid04'>
              <em className='txt'>归还<br />次数</em>
              <button className='btn-up' onClick={() => this._choseSortType(5, 'TODAY_RETURN_DEVICE_NUM', 'ASC')} />
              <button className='btn-down' onClick={() => this._choseSortType(6, 'TODAY_RETURN_DEVICE_NUM', 'DESC')} />
            ...
            <span className='th wid05'>
              <em className='txt'>设备日均<br />借出数</em>
            </span>
          </div>
        </ScrollOnTop>
        {/* 异常处理 */}
                  ...
                  <table className='summary'>
                    <tbody>
                      <tr className='tr clearfix' onClick={i === this.state.showIndex && this.state.isShow ? (e) => this._hide(e, i) : (e) => this._show(e, i, item.shopId)}>
                        ...
                        <td className='wid03'>{item.todayLoanDeviceNum || 0}</td>
                        <td className='wid04'>{item.todayReturnDeviceNum || 0}</td>
                        <td className='wid05'>{item.todaySuccessOrderNum || 0}<i className='dianfont icon-fenlei' /></td>
                      </tr>
                    </tbody>
                  </table>
                        ...
                        {this.props.deviceList && this.props.deviceList.map((item2, j) => {
                          return (
                            <tr className='tr clearfix' key={j}>
                              ...
                              <td className='wid03'>{item2.todayLoanDeviceNum || 0}</td>
                              <td className='wid04'>{item2.todayReturnDeviceNum || 0}</td>
                              <td className='wid05'>{item2.todaySuccessOrderNum || 0}</td>
                            </tr>
                          )
                        })
                        }
      ...
      switch (this.props.location.query.role) {
        case 'ceo':
          this.props.actions.fetchBoxData({
            ...
            firLocation: 'TODAY_LOAN_DEVICE_NUM',
