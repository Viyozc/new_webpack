      ...
      <div>
        ...
        ? <div className='summary'>
          <span className='summary-ele'>
            <span className='num'>{(parseFloat(this.props.summaryData.totalIceDeposit || 0) / 100).toFixed(2)}</span>
            <span className='desc'>累计押金总额</span>
          </span>
          <span className='summary-ele'>
            <span className='num'>{(parseFloat(this.props.summaryData.totalChargeMoney || 0) / 100).toFixed(2)}</span>
            <span className='desc'>累计充值金额</span>
          </span>
          <span className='summary-ele'>
            <span className='num'>{(parseFloat(this.props.summaryData.totalSuccessOrderMoney || 0) / 100).toFixed(2)}</span>
            <span className='desc'>累计成功订单金额</span>
          </span>
          <span className='summary-ele'>
            <span className='num'>{(parseFloat(this.props.summaryData.totalAccountBalance || 0) / 100).toFixed(2)}</span>
            <span className='desc'>累计充值总余额</span>
          </span>
        ...
        <ScrollOnTop className="scroll-on-top-wap">
          <div className='table-head'>
            ...
            <span className='th wid02'>
              ...
              <button className='btn-up' onClick={() => this._choseSortType(3, 'totalIceDepositList', 'ASC')} />
              <button className='btn-down' onClick={() => this._choseSortType(4, 'totalIceDepositList', 'DESC')} />
            ...
            <span className='th wid03'>
              ...
              <button className='btn-up' onClick={() => this._choseSortType(5, 'totalChargeMoneyList', 'ASC')} />
              <button className='btn-down' onClick={() => this._choseSortType(6, 'totalChargeMoneyList', 'DESC')} />
            ...
            <span className='th wid04'>
              ...
              <button className='btn-up' onClick={() => this._choseSortType(7, 'totalSuccessOrderMoneyList', 'ASC')} />
              <button className='btn-down' onClick={() => this._choseSortType(8, 'totalSuccessOrderMoneyList', 'DESC')} />
        ...
        {this.props.list && this.props.summaryData && this.props.list.length > 0
          ? this.state.sortList.map((item, i) => {
            return <div className='table-line' key={i}>
              ...
              <span className='td wid02'>{(parseFloat(item.totalIceDepositList || 0) / 100).toFixed(2)}</span>
              <span className='td wid03'>{(parseFloat(item.totalChargeMoneyList || 0) / 100).toFixed(2)}</span>
              <span className='td wid04'>{(parseFloat(item.totalSuccessOrderMoneyList || 0) / 100).toFixed(2)}</span>
            </div>
          }) : null}
      </div>
    )
    ...
    switch (this.props.location.query.role) {
      case 'ceo':
        ...
        this.props.actions.fetchBoxData({
          ...
          firLocation: 'TOTAL_ACCOUNT_BALANCE',
