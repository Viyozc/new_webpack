...
class Container extends Component {
  constructor (props) { // eslint-disable-line
    ...
    this.state = {
      ...
      timeId: this.props.location.query.timeId || 1,
  ...
  render () {
    ...
    timeList.map((item, i) => {
      ...
      let obj = {
        id: dayTime.getFullYear() + '-' + (dayTime.getMonth() + 1) + '-' + dayTime.getDate(),
        name: dayTime.getFullYear() + '-' + (dayTime.getMonth() + 1) + '-' + dayTime.getDate(),
        childs: [
          {id: '00-24', name: '所有时段'},
          {id: '00-03', name: '00-03'},
          {id: '03-06', name: '03-06'},
