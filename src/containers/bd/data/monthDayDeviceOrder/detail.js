...
class Container extends Component {
  ...
  componentDidMount () {
    Bridge.setNavTitle('绩效-设备日均订单数详情')
      ...
      <div>
        ...
        <ScrollOnTop className="scroll-on-top-wap">
          <div className='shop-data-head'>
            ...
            <span className='th wid02'>
              <em className='txt'>当日总<br />设备数</em>
            ...
            <span className='th wid03'>
              <em className='txt'>当日成<br />功订单<br />数</em>
            ...
            <span className='th wid04'>
              ...
              <button className='btn-up' onClick={() => this._choseSortType(5, 'AVERAGE_ORDER', 'ASC')} />
        ...
        ? this.props.list.map((item, i) => {
          return <div className='shop-data-line' key={i}>
            ...
            <span className='td wid04'>{item.averageOrder}</span>
          </div>
        }) : null}
      </div>
    )
