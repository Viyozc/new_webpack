      ...
      <div>
        ...
        {this.props.summaryData && !this.props.error
          ? <div className='summary'>
            <span className='num'>{this.props.summaryData.averageOrder || 0}</span>
            <span className='desc'>绩效设备日均订单数</span>
        ...
        <ScrollOnTop className="scroll-on-top-wap">
          <div className='shop-data-head'>
            ...
            <span className='th wid02'>
              <em className='txt'>当日绩效<br />总设备数</em>
            ...
            <span className='th wid03'>
              <em className='txt'>当日绩效<br />成功订单数</em>
              <button className='btn-up' onClick={() => this._choseSortType(5, 'SUCCESS_ORDERR_NUM', 'ASC')} />
              <button className='btn-down' onClick={() => this._choseSortType(6, 'SUCCESS_ORDERR_NUM', 'DESC')} />
            ...
            <span className='th wid04'>
              <em className='txt'>设备日<br />均订单<br />数</em>
        ...
        {this.props.list && !this.props.error && this.props.list.length > 0
         ? this.props.list && this.props.list.map((item, i) => {
           ...
           {/*return <div className='shop-data-line' onClick={!isBd ? () => router.push('/bd/data/monthDayDeviceOrder/detail?date=' + date + '&role=' + this.props.location.query.role) : null} key={i}>*/}
             ...
             <span className='td wid04'>
               {parseFloat(item.averageOrder || 0).toFixed(2)}
