    ...
    return (
      <div>
        ...
        ? <div className='summary'>
          <span className='num'>{this.props.summaryData.newInstallShopNum || 0}</span>
          <span className='desc'>绩效新安装门店数</span>
        ...
        <ScrollOnTop className="scroll-on-top-wap">
          <div className='shop-data-head'>
            ...
            <span className='th wid02'>
              <em className='txt'>新增<br />门店<br />数</em>
            ...
            <span className='th wid04'>
              <em className='txt'>总门<br />店数</em>
              <button className='btn-up' onClick={() => this._choseSortType(7, 'SHOP_NUM', 'ASC')} />
              <button className='btn-down' onClick={() => this._choseSortType(8, 'SHOP_NUM', 'DESC')} />
            ...
            <span className='th wid05'>
              <em className='txt'>总门<br />店订<br />单数</em>
        ...
        {(!this.props.error && this.props.list && this.props.list.length === 0)
          ...
          : null}
        {/* 数据列表 */}
        {this.props.list && this.props.list.length > 0 && !this.props.error
        ? this.props.list && this.props.list.map((item, i) => {
          ...
          {/*return <div className='shop-data-line' onClick={!isBd ? () => router.push('/bd/data/monthNewShop/detail?date=' + date + '&role=' + this.props.location.query.role) : null} key={i}>*/}
            ...
            <span className='td wid04'>{item.shopNum}</span>
