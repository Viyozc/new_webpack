...
class MonthNewShopDetailContainer extends Component {
  ...
  componentDidMount () {
    Bridge.setNavTitle('绩效-新安装门店数详情')
      ...
      <div>
        ...
        <ScrollOnTop className="scroll-on-top-wap">
          <div className='shop-data-head'>
            ...
            <span className='th wid02'>
              ...
              <button className='btn-up' onClick={() => this._choseSortType(1, 'NEW_INSTALL_SHOP_NUM', 'ASC')} />
              <button className='btn-down' onClick={() => this._choseSortType(2, 'NEW_INSTALL_SHOP_NUM', 'DESC')} />
            ...
            <span className='th wid03'>
              ...
              <button className='btn-up' onClick={() => this._choseSortType(3, 'NEW_INSTALL_DEVICE_NUM', 'ASC')} />
              <button className='btn-down' onClick={() => this._choseSortType(4, 'NEW_INSTALL_DEVICE_NUM', 'DESC')} />
            ...
            <span className='th wid04'>
              ...
              <button className='btn-up' onClick={() => this._choseSortType(5, 'SHOP_NUM', 'ASC')} />
              <button className='btn-down' onClick={() => this._choseSortType(6, 'SHOP_NUM', 'DESC')} />
            ...
            <span className='th wid05'>
              ...
              <button className='btn-up' onClick={() => this._choseSortType(7, 'SUCCESS_ORDERR_NUM', 'ASC')} />
              <button className='btn-down' onClick={() => this._choseSortType(8, 'SUCCESS_ORDERR_NUM', 'DESC')} />
        ...
        ? this.props.list && this.props.list.map((item, i) => {
          return <div className='shop-data-line' key={i}>
            ...
            <span className='td wid05'>{item.successOrderNum}</span>
          </div>
        }) : null}
      </div>
    )
    ...
    switch (this.props.location.query.role) {
      case 'ceo':
        this.props.actions.fetchMonthData({
          ...
          perfSortField: this.state.sortDesc || 'NEW_INSTALL_SHOP_NUM',
...
export default connect(mapStateToProps, mapDispatchToProps)(MonthNewShopDetailContainer)
